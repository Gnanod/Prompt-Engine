export const CATEGORY_TEMPLATES = {
    ...
    football: {
        ...
        themeSubtextPairs: [
            ...
            ['CHI DOMINA DI PIÙ IN CAMPO?', 'SE DOVESSI SCEGLIERNE UNO, CHI PRENDERSTI?'],
            ['CHI LASCIA IL SEGNO PIÙ FORTE?', 'COMMENTA SOLO UN NOME'],
            ['CHI È PIÙ DECISIVO?', 'CHI TI DÀ PIÙ FIDUCIA OGGI?'],
            ['CHI HA LA MENTALITÀ DA CAMPIONE?', 'VOTA NEI COMMENTI'],
            ['CHI PORTERESTI NELLA TUA SQUADRA?', 'SCRIVI IL SUO NOME QUI SOTTO'],
            ['CHI FA PIÙ PAURA AGLI AVVERSARI?', 'DIMMI CHI SCEGLI E PERCHÉ'],
            ['CHI HA PIÙ CLASSE?', 'COMMENTA IL TUO TOP PLAYER'],
            ['CHI PUÒ CAMBIARE LA PARTITA?', 'SEI TEAM 1 O TEAM 2?'],
            ['CHI MERITA PIÙ RISPETTO?', 'SCRIVI LA TUA SCELTA NEI COMMENTI'],
            ['CHI METTERESTI AL PRIMO POSTO?', 'CHI VINCE QUESTO DUELLO SECONDO TE?'],
        ],
